...
const MyHero = () => {
  return (
    <div 
      className="w-full mx-auto px-6 lg:px-12 relative bg-cover bg-center bg-image"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="p-4 flex flex-col justify-center text-center md:text-left">
            ...
            <div className="mt-6 flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0">
              ...
              <button className="px-6 py-3 text-sm font-medium bg-white rounded-lg shadow-md hover:bg-gray-100 transition-all duration-300">
                Ver Catálogo
              </button>
            </div>
          </div>

          {/* Espacio para la columna de la derecha (opcional) */}
